...
public class Task<TResult> {
	...
	public static <TResult> Task<TResult> forResult(TResult value) {
		TaskCompletionSource tcs = Task.<TResult> create();
		tcs.setResult(value);
		return tcs.getTask();
	}
	...
	public static <TResult> Task<TResult> call(
		...
		final TaskCompletionSource tcs = Task.<TResult> create();
	...
	public static Task<Void> whenAll(Collection<? extends Task<?>> tasks) {
		...
		final TaskCompletionSource allFinished = Task
				.<Void> create();
	...
	public <TContinuationResult> Task<TContinuationResult> continueWith(
		...
		final TaskCompletionSource tcs = Task
